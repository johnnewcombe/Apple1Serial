...
apple1serial-C000.bin:
	xa -DOFFSET="0" -W -C -v -O ASCII -P apple1serial-C000.lst -c src/apple1serial.a65 -l apple1serial-C000.label -o apple1serial-C000.bin

apple1serial-C300.bin:
	xa -DOFFSET="768" -W -C -v -O ASCII -P apple1serial-C300.lst -c src/apple1serial.a65 -l apple1serial-C300.label -o apple1serial-C300.bin

apple1serial-C600.bin:
	xa -DOFFSET="1536" -W -C -v -O ASCII -P apple1serial-C400.lst -c src/apple1serial.a65 -l apple1serial-C600.label -o apple1serial-C600.bin


all: apple1serial-C000.bin apple1serial-C300.bin apple1serial-C600.bin

clean:
	rm -f apple1serial*.bin apple1serial*.label apple1serial*.lst
